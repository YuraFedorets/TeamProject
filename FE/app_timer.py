...
.nav-btn.active::after {
    ...
    background: #ff4d4d;
       ...
       .landing-hero { 
    /* Використовуємо лінійний градієнт для затемнення та вашу картинку */
    ...
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3 cursor-pointer shrink-0" onclick="window.location.href='/'">
            <div class="bg-white p-2 rounded-lg flex items-center justify-center" style="width: 38px; height: 38px;">
                <i class="fas fa-graduation-cap" style="color: #a91825;"></i>
            </div>
...
<div class="landing-hero min-h-screen flex items-center justify-center text-center px-4">
    <div class="max-w-4xl">
        <h1 class="text-5xl md:text-7xl font-black uppercase mb-6 drop-shadow-lg text-white">
            Знайди Своє <span style="color: #a91825;">Майбутнє</span>
        </h1>
...
{% else %}
    ...
    Ласкаво просимо до <span style="color: #a91825;">УКД Talent</span>
</h1>
